...
Public Class AllExamDetails
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kuckoos_SMS.AllExamDetails.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAllExamDetails
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AllExamDetails = New AllExamDetails()
        rpt.Site = Me.Site
        Return rpt
    End Function
