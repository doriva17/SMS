...
Public Class StaaffDetailNon
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Kuckoos_SMS.StaaffDetailNon.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStaaffDetailNon
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StaaffDetailNon = New StaaffDetailNon()
        rpt.Site = Me.Site
        Return rpt
    End Function
